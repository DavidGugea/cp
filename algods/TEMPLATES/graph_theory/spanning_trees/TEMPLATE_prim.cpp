...
// Prim [adjacency list implementation with pq]. Use case: Sparse graphs
// adj: adjacency list | n: no. of vertices
// O(ElogV)
...
// Prim [adjacency matrix implementation min linear scan]. Use case: Dense graphs
// adj: adjacency matrix | n: no. of vertices
// O(V^2)
